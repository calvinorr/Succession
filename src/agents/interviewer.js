...
// REMOVED: ROLE_TOPIC_CHECKLISTS - Role-based checklists removed in favour of topic-based architecture
// Topics are now stored in the database via /topics endpoints
